...
declare class NodeRtmpSession {
    ...
    rtmpChunkMessageHeaderRead(): any;
    rtmpPacketAlloc(): any;
    ...
    sendACK(): void;
    sendWindowACK(): void;
    setPeerBandwidth(): void;
    setChunkSize(): void;
    sendStreamStatus(): void;
    sendInvokeMessage(): void;
    sendDataMessage(): void;
    sendStatusMessage(): void;
    sendRtmpSampleAccess(): void;
    sendPingRequest(): void;
    respondConnect(): void;
    respondCreateStream(): void;
    respondPlay(): void;
    onConnect(): any;
    onCreateStream(): void;
    onPublish(): any;
...
declare class NodeMediaServer {
    ...
    check(eventName: string, listener: (id: string, StreamPath: string, args: object) => void): void;
}
